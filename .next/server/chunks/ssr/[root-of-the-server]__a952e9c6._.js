...
;
;
const apiBaseUrl = ("TURBOPACK compile-time value", "http://localhost:8000/api") || 'https://localhost:8000/api';
...
async function changePassword(data) {
    return await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$axios$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].put('/change-password/', data);
}
async function getUsers(data) {
    return await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$axios$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get('/users/', {
        params: {
            ...data
        }
    });
...
async function forgetPassword(email) {
    return await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$axios$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post('/password-reset/', {
        email
    });
}
async function resetPassword(data) {
    return await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$axios$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post(`/password-reset/confirm/?token=${data.token}`, data);
}
async function updateProfile(data) {
    return await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$axios$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].patch(`/update-profile/${data.id}/`, data);
}
...
const AuthProvider = ({ children })=>{
    ...
    const login = (token)=>{
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$userService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["userService"].getCurrentUser().then((response)=>{
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].error('failed to fetch current user');
        });
    };
    const logout = ()=>{
        localStorage.removeItem('access');
...
"[project]/components/CartContext.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const CartProvider = ({ children })=>{
    ...
    // Total Quantity
    const totalQuantity = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a952e9c6._.js.map